...
For the full internals of the alternatives ranker — the 6-step request flow, scoring weights and gates, the SLM 4-tier lookup, config files, environment variables, and connection-pool architecture — see **[Medication Alternatives: Complete Reference](medication-alternatives.md)**.
